...
class AutoFeatureSelection: 
    ...
    def image_processing(data,targets,resize):
        training_data,label_mapping, cats=AutoFeatureSelection.create_training_data(data,targets,resize)
        ...
        for category in target:
            ...
            for img in os.listdir(path):
                try:
                    ...
                    pass
            categories_imgs.append({"cat_name": category, "cat_count": num_images_in_cat, "label": class_num})
        return (training_data,label_mapping,categories_imgs)
